...
$b = new \Symfony\Component\Cache\DoctrineProvider(($this->services['cache.app'] ?? $this->load('getCache_AppService.php')));
...
$a->setMetadataCacheImpl(new \Symfony\Component\Cache\DoctrineProvider(($this->services['cache.system'] ?? $this->load('getCache_SystemService.php'))));
